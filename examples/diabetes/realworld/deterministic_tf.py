...
model_dir = "./tmp/models/diabetes/realworld/deterministic_tf"
...
for i in range(1, 151, 3):
  ...
  #   # Generate report
  #   tex = report.to_latex(
  #       output_file="tmp/results/diabetes/realworld/deterministic_tf/val_epoch{}_report.tex".
  #       format(i),
  #       title="Diabetes realworld benchmark with Deterministic baseline")
  #   print(tex)
...
# Generate report
tex = report.to_latex(
    output_file="tmp/results/diabetes/realworld/deterministic_tf/report.tex",
    title="Diabetes real-world benchmark with Deterministic baseline")
print(tex)
